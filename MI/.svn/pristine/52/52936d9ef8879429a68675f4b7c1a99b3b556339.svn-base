...
<div>
	...
	<form action="/submit/submit" method="post" name="step3F">
		<fieldset id="contents">
			...
			<div>
				...
				<table class="bottomBtn">
					<tbody>
						<tr>
							<td><input type="button" value="이전 단계" onclick="javascript:history.go(-1)" /></td>
							<td><input type="button" value="민원신청하기" onclick="checkStep3()" /></td>
							<td><input type="button" value="취소" onclick="javascript:window.location.href='/'" /></td>
						</tr>
					</tbody>
				</table>
			</div>

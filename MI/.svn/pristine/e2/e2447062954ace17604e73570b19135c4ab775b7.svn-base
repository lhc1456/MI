...
<div>
	<form action="/member/signup" method="post" name="reg_frm">
		<fieldset>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2">
							...
							</select>-<input type="text" name="tel02" maxlength="4" class="inAreaOther">-<input type="text" name="tel03" maxlength="4" class="inAreaOther">
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							...
							</select>-<input type="text" name="phone02" maxlength="4" class="inAreaOther" required="required">-<input type=text name="phone03" maxlength="4" class="inAreaOther" required="required">
						</td>
						<td></td>
					</tr>
					<tr>
